...
<div class="container">
	...
	<center><h3> Input data for Comparision of Subarea-Wise Manpower </h3> </center>


	<div class="form-container">
		<div class="form-container-form">
			<form class="form-horizontal" method="POST" action="<?=site_url('pages/get_compare_for_subarea')?>">
