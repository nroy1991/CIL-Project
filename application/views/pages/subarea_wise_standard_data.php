...
<div class="container">
	...
	<center><h3> Input data for Subarea-Wise Standard Manpower </h3> </center>


	<div class="form-container">
		<div class="form-container-form">
			<form class="form-horizontal" method="POST" action="<?=site_url('pages/select_mines_for_subarea')?>">
