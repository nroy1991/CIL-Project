...
<div class="container">
  ...
  <center><h3> Upload Subarea Office Existing Manpower Data </h3> </center>


  <div class="form-container">
    <div class="form-container-form">
      <form class="form-horizontal" id="import_csv" method="POST" action="<?=site_url('pages/import_subarea_office_existing_manpower')?>" enctype="multipart/form-data">
