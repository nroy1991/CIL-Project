...
<div class="container">
	...
	<center><h3> Input data for Comparision of Subarea Office Manpower </h3> </center>


	<div class="form-container">
		<div class="form-container-form">
			<form class="form-horizontal" method="POST" action="<?=site_url('pages/get_compare_for_subarea_office')?>">
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
					<label class="control-label col-sm-2" for="subarea_name">Subarea Office:</label>
					<div class="col-sm-10">
				   <select name="subarea_name" id="subarea_name" class="form-control input-lg">
				    <option value="">Select Subarea Office</option>
				   </select>
				    </div>
				 </div>
