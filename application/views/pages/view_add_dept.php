...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8 col-sm-8">
			<?php echo form_open_multipart('departments/save_dept'); ?>
			...
			<div class="row">
			    <div class="col-md-12  ">
			        ...
			        <div class="box box-solid box-primary" id="form">
			            ...
			            <div class="box-body">
			                ...
			                <div class="row">
			                    ...
			                    <div class="col-md-3">
			                        <div class="form-group">
			                            <?php echo form_input(array('name' => 'department', 'id' => 'department', 'placeholder' => 'Department', 'class' => 'form-control', 'required' => 'required')) ?>
			                        </div>
			                    </div>
