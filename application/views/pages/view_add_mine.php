				...
				<div class="col-md-12  ">
			        ...
			        <div class="box box-solid box-primary">
			            <div class="box-header">
			                <h2 class="text-center" ><div id="header"><?php echo "$header";?></div></h2>
			                <br>
			            </div>
			            ...
			            <div class="box-body">
			                <div class="row">
			                    ...
			                    <div class="col-md-3">
			                        <div class="form-group">
			                            <?php echo form_input(array('name' => 'minecategory', 'id' => 'minecategory', 'placeholder' => 'Type of Mine', 'required' => 'required', 'class' => 'form-control')) ?>
			                        </div>
			                    </div>
			                    ...
			                    <div class="col-md-3">
			                        <div class="form-group">
			                            <?php echo form_input(array('name' => 'munit', 'id' => 'munit','class' => 'form-control', 'required' => 'required')) ?>
			                        </div>
			                    </div>
