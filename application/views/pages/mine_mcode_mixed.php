...
<body style=" background-image: url('<?php echo  base_url("assets/images/cilOffice.jpg"); ?>') ; background-position: center center;
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-8 col-md-8 container-fluid">
				<h2 align="center">Mine Type & Mcode(Mixed Mines)</h2>
				<br>
				<div class="row">
				...
				<table style="width:100rem!important; margin:auto!important"class="table table-bordered table-striped">
			        <thead>
			            <tr>
			                <th class="text-center">Mcode</th>
			                <th class="text-center">Mine Type</th>
			                <th class="text-center">Production Unit</th>
			                <th class="text-center">Lower Limit(UG)</th>
			                <th class="text-center">Upper Limit(UG)</th>
			                <th class="text-center">Lower Limit(OC)</th>
			                <th class="text-center">Upper Limit(OC)</th>
			        ...
			        <tbody align="center">
			            ...
			            if(isset($values)){
			                foreach($values as $row){
			                    echo '
			                        <tr>
			                            <td>'.$row['mcode_mixed'].'</td>
			                            <td>'.$row['minecategory'].'</td>
			                            <td>'.$row['munit'].'</td>
			                            <td>'.$row['plower_lim_UG'].'</td>
			                            <td>'.$row['pupper_lim_UG'].'</td>
			                            <td>'.$row['plower_lim_OC'].'</td>
			                            <td>'.$row['pupper_lim_OC'].'</td>
			                            <td>'.$row['wef'].'</td>
			                            <td>'.$row['status'].'</td>
			                        </tr>';
