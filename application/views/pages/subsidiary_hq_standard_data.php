...
<div class="container">
	...
	<center><h3> Input data for Subsidiary Headquarter Standard Manpower </h3> </center>


	<div class="form-container">
		<div class="form-container-form">
			<form class="form-horizontal" method="POST" action="<?=site_url('pages/select_hq_for_subsidiary')?>">
