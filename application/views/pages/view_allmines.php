	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				...
				<table style="margin-left: -10vw!important;" class="table table-bordered table-striped" style="width:100%">
			        <thead>
			            <tr>
							...
							<th class="text-center">Coal Departmental(Mm3)</th>
							<th class="text-center">Coal Outsource(Mm3)</th>
			                <th class="text-center">Total Coal(Mm3)</th>
			    ...
			    <form method="post" id="import_csv" action="<?php echo base_url();?>index.php/pages/import_mine_csv" enctype="multipart/form-data">
