<div class="container">
	<div class="row">
		...
		<div class="col-md-8 col-sm-8">
			<?php echo form_open_multipart('cadre/update_cad'); ?>
			        ...
			        <div class="box box-solid box-primary">
			            ...
			            <div class="box-body">
			                ...
			                <div class="row">
			                    ...
			                    <div class="col-md-3">
			                        <div class="form-group">
			                            <?php echo form_input(array('name' => 'cil_cadre', 'id' => 'cil_cadre', 'value' => $cad['cil_cadre'], 'required' =>'required', 'class' => 'form-control')) ?>
			                        </div>
			                    </div>
