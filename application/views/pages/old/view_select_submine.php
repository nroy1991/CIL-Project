<?php echo form_open_multipart('mines/submine_data'); ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="row">
					...
					<div class="col-md-4">
	                    <div class="form-group">
	                        <label for="submine">Select Submine<i style="color:red; font-size:14px;" >*</i></label>
	                    </div>
	                </div>
	                ...
	                <div class="col-md-4">
	                    <div class="form-group">
	                       <?php
	                            echo form_dropdown('submine', $arr, '', 'class="form-control" id="submine"');
	                        ?>
	                   </div>
	                </div>
