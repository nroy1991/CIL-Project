			        ...
			        <div class="box box-solid box-primary">
			            ...
			            <div class="box-body">
			                ...
			                <div class="row">
			                    ...
			                    <div class="col-md-3">
			                        <div class="form-group">
			                            <?php echo form_input(array('name' => 'grade', 'id' => 'grade', 'placeholder' => 'Grade', 'class' => 'form-control')) ?>
			                        </div>
			                    </div>
			                    ...
			                    <div class="col-md-3">
			                        <div class="form-group">
			                            <?php echo form_input(array('name' => 'design', 'id' => 'design','class' => 'form-control','placeholder' => 'Designation')) ?>
			                        </div>
			                    </div>
			                        ...
			                        <div class="form-group">
			                           <?php
			                               $options = array(
			                                ...
			                                echo form_dropdown('discipline', $options, '', 'class="form-control" id="discipline"');
			                            ?>
			                       </div>
			                    </div>
