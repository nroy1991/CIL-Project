	...
	<div class="row">
		...
		<div class="col-md-8 col-sm-8">
			...
			<div class="row">
				...
				<div class="col-sm-4 col-md-4">
					<?php echo '<a href="'.site_url("pages/add_grade").'"<button class="btn btn-primary">Edit Grade</button></a>'; ?>
				</div>

				<div class="col-sm-4 col-md-4">
					<?php echo '<a href="'.site_url("pages/add_grade").'"<button class="btn btn-primary">Delete Grade</button></a>'; ?>
				</div>
			        ...
			        <div class="box box-solid box-primary">
			            ...
			            <div class="box-body">
			                ...
			                <div class="row">
			                    ...
			                    <div class="col-md-3">
			                        <div class="form-group">
			                            <?php echo form_input(array('name' => 'grade', 'id' => 'grade', 'placeholder' => $prev['grade'], 'value' => $prev['grade'], 'class' => 'form-control')) ?>
			                        </div>
			                    </div>
			                    ...
			                    <div class="col-md-3">
			                        <div class="form-group">
			                            <?php echo form_input(array('name' => 'design', 'id' => 'design','class' => 'form-control','placeholder' => $prev['design'], 'value' => $prev['design'])) ?>
			                        </div>
			                    </div>
			                        ...
			                        <div class="form-group">
			                           <?php
			                               $options = array(
			                                ...
			                                echo form_dropdown('discipline', $options, $prev['discipline'], 'class="form-control" id="discipline"');
			                            ?>
			                       </div>
			                    </div>
