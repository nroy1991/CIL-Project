<div class="container">
	<div class="row">
		...
		<div class="col-md-8 col-sm-8">
			...
			<div class="row">
				<?php echo form_open_multipart('mines/save_submine'); ?>
				<div class="col-md-12  ">
			        ...
			        <div class="box box-solid box-primary">
			            ...
			            <?php 
			            	$data=array('mine_id'	=>	$mine_info['mine_id']);
			                ...
			                <div class="row">
			                    ...
			                    <div class="col-md-3">
			                        <div class="form-group">
			                            <label for="minecategory">Mine Category</label>
			                        </div>
			                    </div>

			                    <div class="col-md-3">
			                        <div class="form-group">
			                            <?php echo form_input(array('name' => 'minecategory', 'id' => 'minecategory', 'value'	=>	$mine_info['minecategory'], 'readonly'	=>	'true', 'required' => 'required', 'class' => 'form-control')) ?>
			                        </div>
			                    </div>
			                    ...
			                    <div class="col-md-3">
			                        <div class="form-group">
			                            <?php echo form_input(array('name' => 'munit', 'id' => 'munit', 'value'	=>	$mine_info['munit'], 'readonly'	=>	'true', 'required' => 'required', 'class' => 'form-control')) ?>
			                        </div>
			                    </div>
