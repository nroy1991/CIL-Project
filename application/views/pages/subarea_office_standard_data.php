...
<div class="container">
	...
	<center><h3> Input data for Subarea Office Standard Manpower </h3> </center>


	<div class="form-container">
		<div class="form-container-form">
			<form class="form-horizontal" method="POST" action="<?=site_url('pages/select_office_for_subarea')?>">
