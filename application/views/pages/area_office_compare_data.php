...
<div class="container">
	...
	<center><h3> Input data for Comparision of Area Office Manpower </h3> </center>


	<div class="form-container">
		<div class="form-container-form">
			<form class="form-horizontal" method="POST" action="<?=site_url('pages/get_compare_for_area_office')?>">
				...
				<div class="form-group">
					<label class="control-label col-sm-2" for="area_name">Area Office:</label>
					<div class="col-sm-10">
